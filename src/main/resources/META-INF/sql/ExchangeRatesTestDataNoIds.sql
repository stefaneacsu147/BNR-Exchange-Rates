Insert into MONETARYUNIT (DESCRIPTION,NAME) values ('EURO','EUR');
Insert into MONETARYUNIT (DESCRIPTION,NAME) values ('New romanian lei','RON');
Insert into MONETARYUNIT (DESCRIPTION,NAME) values ('US DOLLAR','USD');
Insert into MONETARYUNIT (DESCRIPTION,NAME) values ('Japan rules','JPY');

--object model
Insert into CURRENCYEXCHANGEOBJECTMODEL (CREATIONDATE) values (to_date('01-AUG-17','DD-MON-RR'));
Insert into CURRENCYEXCHANGEOBJECTMODEL (CREATIONDATE) values (to_date('03-AUG-17','DD-MON-RR'));
...
--exchange rates
Insert into EXCHANGERATE (CREATIONDATE,MULTIPLIER,VALUE,FINALMONETARYUNIT_ID,OBJECTMODEL_ID,ORIGINCURRENCY_ID) values (to_date('01-AUG-17','DD-MON-RR'),null,4.5577,1,1,2);
Insert into EXCHANGERATE (CREATIONDATE,MULTIPLIER,VALUE,FINALMONETARYUNIT_ID,OBJECTMODEL_ID,ORIGINCURRENCY_ID) values (to_date('01-AUG-17','DD-MON-RR'),null,3.8569,3,1,2);
Insert into EXCHANGERATE (CREATIONDATE,MULTIPLIER,VALUE,FINALMONETARYUNIT_ID,OBJECTMODEL_ID,ORIGINCURRENCY_ID) values (to_date('01-AUG-17','DD-MON-RR'),100,3.4946,4,1,2);
Insert into EXCHANGERATE (CREATIONDATE,MULTIPLIER,VALUE,FINALMONETARYUNIT_ID,OBJECTMODEL_ID,ORIGINCURRENCY_ID) values (to_date('03-AUG-17','DD-MON-RR'),null,4.5632,1,1,2);
Insert into EXCHANGERATE (CREATIONDATE,MULTIPLIER,VALUE,FINALMONETARYUNIT_ID,OBJECTMODEL_ID,ORIGINCURRENCY_ID) values (to_date('03-AUG-17','DD-MON-RR'),null,3.8524,3,1,2);
Insert into EXCHANGERATE (CREATIONDATE,MULTIPLIER,VALUE,FINALMONETARYUNIT_ID,OBJECTMODEL_ID,ORIGINCURRENCY_ID) values (to_date('03-AUG-17','DD-MON-RR'),100,3.4826,4,1,2);
